    ...
    <nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b md:border-gray-100 dark:border-gray-600 shadow-md border border-gray-200 rounded-lg md:rounded-none" >
        ...
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <span class="object-center	">
            <a class="no-underline " target="_blank" href="https://api.whatsapp.com/send?phone=79283211133">
        ...
        <span class="md:px-2 object-center	">
          <a class="no-underline " target="_blank" href="href="https://t.me/Centr_Dostavki">
...
<footer class="bg-white rounded-lg shadow m-4 mt-8 dark:bg-gray-800">
  ...
  <ul class="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
      ...
      <li>
          <a href="#" class="hover:underline me-4 md:me-6">Политика конфеденциальности</a>
      </li>
      <li>
          <a href="#" class="hover:underline">Разработано: ООО «ИНТЕЛТЕЛЕКОМ ЮГ»</a>
      </li>
  </ul>
  </div>
</footer>
