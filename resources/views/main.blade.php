...
<img class="object-cover object-center w-full h-96 md:h-144 blur-sm border-0  md:rounded-xl"  src="{{ url('images/fon.png')}}" alt="Купер - доставка супер">
<div class="md:rounded-xl border-0 absolute oobject-cover mt-16 object-top  opacity-70 top-0 w-full h-96 md:h-144 bg-gradient-to-r from-gray-600 to-gray-500">             
</div>
<div class="absolute object-center top-40 md:top-1/3 md:left-48 md:w-1/3 w-full"> 
            <h2 class="mb-4 md:text-4xl text-2xl font-bold tracking-tight text-white mx-4">Стань курьером!</h2>
            <p class="md:mb-8 mb-2 text-white md:text-3xl text-xl font-bold tracking-tight mx-4">Огромное количество заказов через приложение ждет вас!</p>
            <p class="md:mb-8 mb-6 text-white  md:text-3xl text-xl font-bold tracking-tight mx-4">Зарегистрируйся в два клика</p>
            <a href="{{ route('reg') }}" class="text-white my-6 mx-4 hover:shadow-md bg-gazprom hover:bg-orange-400 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg md:text-3xl text-xl px-4 py-3 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Стать курьером!</a>
            </div>
...
<div id="vacancy" class="inline-flex items-center justify-center w-full ">
    <hr class="md:w-2/3 w-full h-0.5 md:h-1 my-8 bg-gazprom border-0 dark:bg-gray-700">
...
<a href="{{ route('reg') }}" class="mx-2 flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-4xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
    ...
    <div class="flex flex-col justify-between p-4 leading-normal">
        ...
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Пеший курьер забирает заказ и доставляет пешком до двери клиента. Заказы поступают из ближайших магазинов и ресторанов. Радиус до 3 км</p>
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Условия</h5>
        <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
    <li class="flex items-center">
        <svg class="w-3.5 h-3.5 me-2 text-gazprom dark:text-green-400 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
...
<a href="{{ route('reg') }}" class="mx-2 flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-4xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
    ...
    <div class="flex flex-col justify-between p-4 leading-normal">
        ...
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Велоуниверсал собирает и доставляет заказ до двери клиента на велосипеде. В территорию входит несколько магазинов. Заказы поступают из ближайшего магазина. Радиус до 5 км</p>
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Условия</h5>
        <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
    <li class="flex items-center">
        <svg class="w-3.5 h-3.5 me-2 text-gazprom dark:text-green-400 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
...
<div id="accordion-open" data-accordion="open" class="md:w-2/3 w-full border-1 border-gray-200 rounded-xl">
  ...
  <div id="accordion-open-body-1" class="hidden" aria-labelledby="accordion-open-heading-1">
    <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
      <p class="mb-2 text-gray-600 dark:text-gray-400">Деньги выплачиваются каждую неделю на карту любого банка</p>
    </div>
  </div>
  ...
  <div id="accordion-open-body-2" class="hidden" aria-labelledby="accordion-open-heading-2">
    <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700">
      <p class="mb-2 text-gray-600 dark:text-gray-400">Пешие и вело-курьеры доставляют
в пределах 3-5 км. Авто-курьеры доставляют в радиусе 10 км</p>
    </div>
  </div>
  <h2 id="accordion-open-heading-3">
    <button type="button" class="shadow flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-700 border border-gray-200 focus:ring-2 focus:ring-gazprom dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3" data-accordion-target="#accordion-open-body-3" aria-expanded="false" aria-controls="accordion-open-body-3">
      <span class="flex items-center"><svg class="w-5 h-5 me-2 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"></path></svg> Нужна ли мед. книжка?</span>
      <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5 5 1 1 5"/>
      </svg>
    </button>
  ...
  <div id="accordion-open-body-3" class="hidden" aria-labelledby="accordion-open-heading-3">
    <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
      <p class="mb-2 text-gray-600 dark:text-gray-400">Да. Ее наличее обязательно.
Если у вас нет - поможем оформить</p>
  ...
  <h2 id="accordion-open-heading-5">
    <button type="button" class="shadow flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-700 border border-gray-200 focus:ring-2 focus:ring-gazprom dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3" data-accordion-target="#accordion-open-body-5" aria-expanded="false" aria-controls="accordion-open-body-5">
      <span class="flex items-center"><svg class="w-5 h-5 me-2 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"></path></svg> Какая форма трудоустройства?</span>
      <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5 5 1 1 5"/>
      </svg>
    </button>
  ...
  <div id="accordion-open-body-5" class="hidden" aria-labelledby="accordion-open-heading-5">
    <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
      <p class="mb-2 text-gray-600 dark:text-gray-400">Все сотрудники устраиваются по договору оказания услуг и получают статус самозанятого</p>
